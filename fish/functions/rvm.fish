# THIS FILE WAS DOWNLOADED FROM: https://rvm.io/integration/fish
# WITH: curl -L --create-dirs -o ~/.config/fish/functions/rvm.fish https://raw.github.com/lunks/fish-nuggets/master/functions/rvm.fish
